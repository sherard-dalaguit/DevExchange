...
const LeftSidebar = () => {
    ...
    return (
        <section
            className="flex flex-col h-screen background-light900_dark200 light-border
            sticky left-0 top-0 justify-between overflow-y-auto border-r p-6 
                    ...
                    return (
                        <Link 
                            ...
                            className={`${isActive
                                ...
                                } flex items-left justify-start gap-4 bg-transparent p-4`}    
                        >
                            <Image 
                                src={item.imgURL} 
                                width={20}
